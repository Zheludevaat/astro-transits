...
conjunction:{label:'Fusion',feel:'Intensely focused',
  ...
  advice:'Don\'t resist the merge. Whatever this transit is bringing, commit to it fully. Half-measures won\'t work under a conjunction.'},
...
Chiron_conjunction_Moon:'Chiron is pressing on your deepest emotional wounds — particularly around nurturing, belonging, and mother. Old feelings of abandonment, emotional neglect, or not being allowed to have needs may surface with surprising intensity. This is deep healing work. The grief that surfaces now is not new; it is old pain finally finding its way out, and it will not break you the way it would have broken the child who first felt it.',
...
Pluto_square_Sun:'Pluto is creating intense friction with your core identity. Power struggles, control issues, and confrontations with dark truths about yourself and others dominate. Something about how you\'ve been living is fundamentally unsustainable and Pluto is forcing a crisis to catalyze change. The power struggle you are losing is with an outdated version of yourself — stop defending the position and let the crisis show you what actually needs to change.',
...
Neptune_square_Moon:'Neptune dissolves your emotional boundaries, creating heightened sensitivity, confusion, and vulnerability. You absorb others\' emotions like a sponge. Dreams are vivid and meaningful but daily life feels foggy. Family secrets or illusions about your childhood may surface. If you are going to feel everything this intensely, make something from it — write, paint, compose — because Neptune square Moon without an outlet just becomes a drinking problem.',
...
// ── Additional conjunction transits ──
Jupiter_conjunction_Venus:'Jupiter is expanding your capacity for love, pleasure, and connection. This is one of the most enjoyable transits in astrology — relationships sweeten, social life flourishes, and financial opportunities arrive through people who genuinely like you. Artistic expression flows with unusual ease. The only risk is overindulgence — too much spending, too much eating, too much yes. Enjoy the abundance but remember that even beautiful things need boundaries.',
Jupiter_conjunction_Mercury:'Jupiter is expanding your mind and amplifying your voice. Ideas come faster, thinking goes bigger, and your words carry unusual persuasive power. This is an excellent window for writing, teaching, signing contracts, and any project that depends on communication. Travel for learning or business is especially favored. Guard against mental overextension — not every grand idea deserves immediate action, so let the best ones prove themselves before committing.',
Jupiter_conjunction_Mars:'Jupiter is supercharging your drive, ambition, and physical energy. You feel unstoppable — bold action pays off, competitive instincts sharpen, and your willingness to take risks is rewarded more than usual. Athletic endeavors, business launches, and assertive moves in your career are all favored. Channel this energy deliberately, because the combination of Jupiter\'s excess and Mars\'s aggression can tip into recklessness or overcommitment if left unchecked.',
Saturn_conjunction_Uranus:'Saturn is sitting on your natal Uranus, creating a powerful tension between structure and freedom in your life. The parts of you that resist authority, crave independence, and rebel against convention are being forced into a mature framework. This can feel suffocating at first — your need for autonomy meets immovable responsibilities. But the result is disciplined innovation: you learn to channel your originality into forms that actually last and function in the real world.',
Saturn_conjunction_Neptune:'Saturn is pressing on your natal Neptune, grounding your dreams, ideals, and spiritual life in cold reality. Illusions you have carried — about yourself, about others, about how life should work — are being tested against what is actually true. This can feel disillusioning or depressing as fantasies dissolve. But Saturn is not destroying your imagination; it is teaching you to build real structures around your highest visions so they become something more than wishful thinking.',
Saturn_conjunction_Pluto:'Saturn is merging with your natal Pluto, activating one of the heaviest transits possible. Deep psychological material — issues of power, control, survival, and your relationship with fear itself — is being restructured at a fundamental level. You may feel an almost unbearable pressure to transform aspects of your life that have been locked in place for years. The intensity is proportional to how much has been suppressed — years of buried fear and locked-down control are being forced to the surface all at once, and what survives this compression will be the most solid thing you have ever built.',
Uranus_conjunction_Mercury:'Uranus is electrifying your Mercury — your thinking, communication, and perception are being rewired at lightning speed. Expect sudden insights, radical new ideas, and a restless inability to think in the old ways. Your nervous system may feel overstimulated as information floods in faster than you can process it. Conversations take unexpected turns, plans change abruptly, and breakthroughs in learning or technology reshape how you interact with the world. The thoughts that keep startling you are not random — they are the ideas your nervous system was not ready for until now.',
Uranus_conjunction_Venus:'Uranus is disrupting your Venus — your relationships, values, and sense of beauty are being jolted awake. Sudden attractions, unexpected breakups, or dramatic shifts in what you find beautiful and valuable are all possible. A relationship that felt stable may suddenly feel stifling, or a completely unexpected person enters your life and changes everything. Financial surprises — both windfalls and losses — can accompany this transit. Freedom in love becomes non-negotiable.',
Uranus_conjunction_Mars:'Uranus is igniting your Mars with volatile, electric energy. Your drive, aggression, and physical vitality become unpredictable and intensely powerful. You may act impulsively, take risks that shock even yourself, or experience sudden bursts of courage that break through old limitations. This transit demands a conscious outlet — athletics, bold creative work, or entrepreneurial action. Without direction, the energy can manifest as accidents, explosive anger, or reckless decisions.',
Neptune_conjunction_Mercury:'Neptune is dissolving the sharp edges of your Mercury — your rational mind, communication style, and everyday perception are becoming more fluid and porous. You may struggle with mental fog, misunderstandings, or difficulty pinning down concrete thoughts. But the gift is extraordinary: your intuition deepens, creative and poetic expression reaches new heights, and you can perceive subtleties that logic alone would miss. Double-check all important communications and avoid signing contracts without careful review.',
Neptune_conjunction_Venus:'Neptune is merging with your Venus, dissolving the boundaries in your experience of love, beauty, and connection. Romantic feelings become transcendent — you may fall into an all-consuming love, idealize a partner beyond recognition, or experience art and music with an intensity that brings you to tears. This is one of the most creatively and spiritually inspired transits possible. The danger is deception in love or finances; what appears beautiful may not be what it seems. Trust but verify.',
Neptune_conjunction_Mars:'Neptune is dissolving your Mars — your drive, assertiveness, and sense of direction may feel confused, weakened, or strangely redirected. Actions you take seem to dissolve into nothing, and you may struggle to find motivation or feel that your efforts are wasted. This transit asks you to surrender the ego\'s agenda and act from a place of compassion or spiritual purpose instead. Ambition fueled by ego dissolves under this transit, but effort in service of something larger than yourself gains a strange, quiet momentum that outlasts the fog.',
Pluto_conjunction_Mercury:'Pluto is transforming how you think, perceive, and communicate at the deepest level. Your mind becomes penetrating, obsessive, and drawn to hidden truths. Surface-level conversation feels unbearable — you need to understand what is really going on beneath every interaction. Research, investigation, psychology, and any work that requires depth of analysis are powerfully favored. Be aware that your words carry unusual power now and can wound or heal with equal force.',
Pluto_conjunction_Venus:'Pluto is merging with your Venus — your experience of love, desire, and value is being transformed at the root. Relationships become intensely passionate, possessive, or obsessive. You may be drawn into a love that consumes you or forced to confront jealousy, manipulation, and control dynamics you have been avoiding. Financial transformation is also possible — assets may be gained or lost in ways that permanently change your relationship with money. What you love after this transit will be what you truly need, stripped of all pretense.',
Pluto_conjunction_Mars:'Pluto is fusing with your Mars, creating an almost volcanic concentration of willpower, ambition, and raw energy. Your drive becomes relentless and your capacity for sustained, intense effort reaches extraordinary levels. This is one of the most powerful transits for achieving difficult goals that require total commitment. But the shadow side is equally potent — rage, obsession, ruthlessness, and power struggles can become consuming if the energy is not consciously directed. Master this force rather than being mastered by it.',
NorthNode_conjunction_Venus:'The North Node is activating your Venus, creating fated encounters in love, friendship, and creative expression. Relationships that begin now carry a sense of destiny — you may meet someone who feels immediately significant, or an existing bond deepens in a way that changes your life direction. Your values and aesthetic sensibility are being aligned with your soul\'s purpose. Pay attention to who shows up now and what makes your chest tighten with recognition — the North Node does not send these people twice.',
NorthNode_conjunction_Mercury:'The North Node is activating your Mercury, bringing fated developments in communication, learning, and intellectual connection. Conversations, ideas, or pieces of information arrive at exactly the right moment to redirect your path. You may meet a teacher, writer, or thinker whose words change how you see everything. Contracts and agreements signed now carry karmic weight. Pay close attention to what you hear and read — the universe is speaking to you through your daily mental environment.',
Chiron_conjunction_Venus:'Chiron is touching your Venus, reopening old wounds around love, beauty, self-worth, and your ability to receive affection. Past rejections, heartbreaks, or feelings of being unlovable may surface with surprising intensity. Relationships become the arena for deep healing — you may attract partners who mirror your wounds or find that giving and receiving love triggers unexpected pain. The gift is profound: by facing these wounds, you develop a capacity for authentic, compassionate love that was not possible before.',
Chiron_conjunction_Mercury:'Chiron is activating your Mercury, bringing old wounds around communication, intelligence, and being heard to the surface. You may revisit painful experiences of being misunderstood, dismissed, or told your ideas did not matter. Speaking and writing become acts of healing — your words carry the weight of lived experience and can reach people in ways that polished rhetoric cannot. This transit teaches you that your unique way of thinking, the one you may have been ashamed of, is exactly what others need to hear.',
};
...
Aries:'Fast. Everything is fast. Reactions fire before thought catches up, and the body wants to move before the mind knows where. This Moon runs hot — flare-ups come quick and burn out just as quick. Act on what matters, drop what doesn\'t, and do not apologize for your impatience today.',
Taurus:'Something in you slows down and refuses to be hurried. Comfort is not optional right now — good food, familiar textures, the weight of a blanket. Feelings settle into the body like sediment. Whatever you already have is enough if you let yourself actually enjoy it.',
Gemini:'Your mind splits into six conversations at once and wants all of them. Restlessness hums underneath everything — not anxiety exactly, more like a radio scanning for the right frequency. Talk it out, text someone back, read something strange. Stillness is the enemy today.',
Cancer:'Everything is closer to the surface than usual. A song, a smell, a memory of someone\'s kitchen — any of it can crack you open. Nurturing instincts run strong, but so does the need to be held. Home is where the gravity pulls. Let it.',
Leo:'Warmth radiates outward whether you intend it or not. There is a need to create, to perform, to be witnessed in some genuine way. Generosity comes easily, but so does the sting of being overlooked. Make something. Show someone. The heart is louder than the head today.',
Virgo:'Small things demand attention — the disorganized shelf, the half-finished task, the body\'s quiet complaints. There is relief in sorting, fixing, making useful. But the urge to perfect can tip into picking yourself apart. Solve the practical problem first; leave the self-criticism for never.',
Libra:'Other people are the weather today. Every interaction registers — tone, fairness, the unspoken thing beneath the polite thing. You want harmony badly enough to bend yourself out of shape for it. Before you do: what do YOU actually need from this exchange?',
Scorpio:'Intensity without an obvious cause. You perceive undercurrents, half-truths, the thing no one is saying out loud. Feelings run deep and do not want to be managed or minimized. Shallow conversation is physically irritating. Go where the real talk is or go alone.',
Sagittarius:'Walls close in. Routine feels like a cage, and something in you needs horizon — a new idea, a foreign paragraph, a conversation with someone who sees the world differently. Optimism swells but so does recklessness. Aim the restlessness at something worth exploring.',
Capricorn:'Feelings get quiet and businesslike. There is a gravity to the day that makes frivolity feel wasteful. You process by doing — finishing the task, meeting the obligation, proving to yourself that you can handle it. Productive, yes. But check whether you are building or just bracing.',
Aquarius:'Personal drama fades and something wider comes into focus — the group, the cause, the idea that matters beyond your own story. Detachment is not coldness; it is clarity. Rational thought runs clean today. Use it for the collective good, not as a shield against feeling.',
Pisces:'Boundaries soften... dissolve, really. Other people\'s moods seep in like weather through old windows. Imagination opens wide, and so does compassion, and so does the risk of absorbing what is not yours. Beautiful for creative work, for prayer, for music. Brutal if you forget where you end and others begin.'
};

// ── Dominant planet flavor for guidance ──
const DOMINANT_FLAVOR={
Saturn:'Weight. That is what you feel in the chest, the shoulders, the jaw you did not realize you were clenching. Saturn days strip out everything nonessential and leave you face-to-face with what must be done. The work is real, the deadline is real, and the only way out is through. Do not numb yourself. Finish something.',
Pluto:'Something underneath is moving. You can feel it in the way small interactions carry outsized charge — a look that lingers too long, a question that hits a nerve, a sudden awareness of who holds power and who does not. Pluto days do not allow surface-level living. Whatever you have been avoiding will find you.',
Neptune:'The edges of things go soft. Sounds carry differently, time slips, and the line between what you imagined and what actually happened gets hard to trace. Your body might feel waterlogged or strangely light. Creative vision is wide open, but so is the door to self-deception. Write it down, paint it, sing it — just do not sign any contracts.',
Uranus:'A crack in the routine. Something breaks the pattern — an idea that arrives fully formed at 2 a.m., a conversation that veers into territory you did not expect, an impulse to quit or start or reverse direction entirely. The nervous system runs electric. Sitting still feels like punishment. Follow the interruption; it knows something you do not.',
Jupiter:'More is available. The day feels wider than usual — more generous, more possible, more willing to say yes. Conversations open doors, strangers become allies, and the thing you thought was out of reach turns out to be closer than you assumed. The only real danger is saying yes to everything and finishing nothing.',
Mars:'The pulse is up. You can feel it in your hands, your pace, the edge in your voice when someone moves too slowly. Mars days hand you a match and a roomful of kindling. Directed well, this is the day you finally do the hard thing — confront, compete, build, push through. Directed poorly, you pick a fight you did not need.',
Venus:'Pleasure is not a distraction today; it is the point. Notice what is beautiful — the meal, the face, the song that stops you mid-step. Relationships smooth out, taste sharpens, and the body remembers what it actually wants. Buy the flowers. Make the call. Wear the thing you have been saving.',
Mercury:'The mind will not stop. Words come quickly, connections form between ideas that seemed unrelated an hour ago, and your phone buzzes like it knows. This is a day for writing, talking, negotiating, and processing out loud. The risk is scattered attention — too many tabs open, not enough depth on any one.',
Sun:'Clarity about who you are. Not who you should be, not who others want — who you ARE, underneath the performance. Purpose feels less abstract and more like a direction you can walk in. Visibility increases, for better or worse. Stand in it.',
Moon:'Feelings shift like weather — fine one hour, tender the next, and you may not know why. The body speaks louder than the mind: cravings, fatigue, a sudden need to be held or left alone. Do not override it with logic. Feed yourself, rest if you need to, and let the mood teach you something.',
Chiron:'An old ache wakes up. Not because something went wrong today, but because you are finally strong enough to look at it. The tender spot — the thing you compensate for, the story you tell yourself to get around the wound — it asks for honest attention. Sitting with it, not fixing it, is the work.',
NorthNode:'Pay attention to what arrives uninvited. The meeting that was not on the calendar, the sentence someone says that lodges in your ribs, the choice that feels less like deciding and more like remembering. Something is pulling you forward. You do not have to understand it yet — just follow the tug.'
};
...
const SPHERE={
Sun:{name:'the Sun',office:'burns away what is false',when_active:'what you truly want becomes visible',when_stressed:'you perform confidence you do not feel, and the distance between the mask and the face becomes unbearable',domain:'identity and authentic expression'},
Moon:{name:'the Moon',office:'remembers what the body knows',when_active:'feelings run close to the surface and instincts sharpen',when_stressed:'you reach for comfort and find the cupboard bare, every surface too bright, every room the wrong temperature',domain:'feeling, memory, and the body\'s rhythms'},
Mercury:{name:'Mercury',office:'names things so they become real',when_active:'your mind is quick and conversations carry weight',when_stressed:'the wire between your mind and your mouth shorts out, and the harder you try to be clear the more garbled it gets',domain:'thought, speech, and the movement of information'},
Venus:{name:'Venus',office:'decides what is worth wanting',when_active:'what you love and what loves you move closer together',when_stressed:'you cannot tell whether you are settling or starving, and every mirror gives a different answer',domain:'desire, beauty, and the bonds between people'},
Mars:{name:'Mars',office:'cuts a path where none exists',when_active:'you have the fuel to push through obstacles',when_stressed:'the anger has no address, so it mails itself to whoever is closest',domain:'action, courage, and the will to contend'},
Jupiter:{name:'Jupiter',office:'finds the pattern that means something',when_active:'doors open and perspective broadens',when_stressed:'you say yes to everything because saying no would mean admitting you do not know which door is the right one',domain:'growth, meaning, and the larger pattern'},
Saturn:{name:'Saturn',office:'makes you build it to last',when_active:'what is solid proves itself and what is not falls away',when_stressed:'the walls you built for protection now have you locked inside, and the schedule has become the warden',domain:'discipline, time, and the consequences of choices'},
Uranus:{name:'Uranus',office:'breaks the agreement you outgrew',when_active:'sudden clarity arrives about what must change',when_stressed:'the ground keeps moving and you cannot plan past Thursday, every foothold provisional, every plan a draft',domain:'authenticity, revolution, and the shock of the new'},
Neptune:{name:'Neptune',office:'erases the line between you and everything',when_active:'intuition sharpens and the imagination opens',when_stressed:'you are not sure if you are being compassionate or just disappeared, and the fog is coming from inside the house',domain:'imagination, spirit, and the longing for what transcends'},
Pluto:{name:'Pluto',office:'kills what you have outgrown',when_active:'something hidden comes to light and demands to be faced',when_stressed:'something underneath is running the show and you can feel it in every room, a low hum of compulsion dressed as necessity',domain:'depth, power, and the death that precedes renewal'},
Chiron:{name:'Chiron',office:'teaches through what never fully closed',when_active:'vulnerability becomes a source of wisdom',when_stressed:'the scar tissue cracks open in public, and you are eleven years old again in a room full of adults',domain:'the wound that teaches, the healer who was first a patient'},
NorthNode:{name:'the North Node',office:'marks the door you have not earned yet',when_active:'encounters feel fated and direction clarifies',when_stressed:'the future is pulling but your hands are full of the past, and every step forward feels like betrayal of something you loved',domain:'destiny, evolution, and the soul\'s trajectory'},
};

// Profected lord framing sentences
const LORD_FRAME={
Sun:'The Sun holds the year. Everything circles back to the question of who you actually are when no one is watching — and whether you can be that person when everyone is. Vitality, visibility, purpose: these are not themes, they are the ground you walk on for twelve months.',
Moon:'Underneath the plans and the calendar, the real life of this year is emotional. The Moon governs: what you need, what you remember, what your body knows before your mind catches up. Home, family, the private self — these run the show now, whether you planned for it or not.',
Mercury:'Quick year. Ideas arrive fast, conversations matter more than usual, and the right (or wrong) word at the right moment can redirect everything. Mercury is running this chapter — expect your phone to ring, your plans to revise, and your mind to be the busiest room in the house.',
Venus:'What you love shapes the year. Not abstractly — literally. The person, the place, the craft, the pleasure you keep returning to: that is where the story lives. Venus governs, and she is not interested in what you should want. Only in what you do.',
Mars:'Expect friction. Expect to need it. Mars years do not hand you anything — they dare you to go get it. Conflict is not a sign that something is wrong; it is the engine. The question is not whether you will fight, but whether you will fight for the right thing.',
Jupiter:'The doors are wider this year. Opportunity knocks more than once, perspective stretches past its usual borders, and faith — in yourself, in the future, in the gamble — comes more naturally than caution. Jupiter is generous, but generosity without direction is just excess. Aim the abundance somewhere real.',
Saturn:'The year is heavy and it means to be. Saturn does not govern lightly. Obligations stack, timelines tighten, and the difference between what you built well and what you rushed becomes impossible to ignore. Nothing is wasted here — but nothing is free either. Do the work. It will hold.',
};
...
conjunction:['A rare convergence','This merger','Total overlay','Two forces fusing','This intensification','The concentration deepens','A blending of forces'],
opposition:['Tension builds between','This face-to-face encounter','A polarization','The mirror sharpens','Pulled in two directions','This dual awareness','A tug-of-war'],
square:['Friction between','This pressure','A structural collision','The challenge lands','Forced reckoning with','This grinding contact','Productive crisis around'],
trine:['The flow runs easy between','This natural cooperation','A mutual resonance','Effortless current through','This inherited grace','An open channel between','Ease surrounds'],
sextile:['A bridge opens between','This gentle cooperation','The angle invites','An opportunity arrives through','Quiet alignment between','This opening toward','Complementary ground between'],
quincunx:['Something sits wrong between','This awkward adjustment','A persistent itch around','Never quite fitting','This off-kilter tension','Recalibration demanded by','An uneasy angle between'],
'semi-sextile':['Quiet friction between','This adjacent restlessness','A background hum from','Subtle transition near','Low-grade tension around','A whispered demand from']
};
...
hard:{
  ...
  NorthNode:['The nodal axis is activated under stress — unfamiliar choices build the skills this chart needs.','Hard node transits rearrange priorities. What you keep putting off is probably the assignment.','The discomfort is developmental, not punitive. The chart is asking you to practice a skill you lack.','North Node squares and oppositions break habits. Notice which routine just stopped working.','When the nodes are pressured, old defaults feel safe but stall progress. Pick the less automatic option.']
},
easy:{
  ...
  NorthNode:['Soft node transits grease the wheels — doors open in the direction the chart already points.','The trine or sextile to your nodes means the current situation supports your longer arc. Say yes.','People and opportunities arriving now tend to align with nodal purpose. Pay attention to who shows up.','Easy node contacts reward choices you have already made in the right direction. Keep going.','The north node work feels less effortful today. Use the window to build habits that stick.']
},
conjunction:{
  ...
  NorthNode:['A planet crossing the north node is a course correction. Events today point toward what the chart is developing.','Conjunctions to the node concentrate karmic material — themes from the last 18 months come to a head.','The node conjunction is a checkpoint. Assess whether recent choices match the direction you actually want.','When a transit planet sits on the north node, the people and situations it rules become pivotal. Watch those houses.','Node conjunctions mark turning points in the nodal cycle. What you commit to now sets the tone for the next phase.']
}
};

// ── Dignity reframes (planet-specific) ──
const DIGNITY_REFRAME_PLANET={
Sun:{domicile:['radiating pure selfhood — identity is unquestioned','the will shines at full wattage, unfiltered and commanding','Leo Sun: this is your house, your throne, your light'],exalted:['exalted confidence — the self rises to meet its highest expression','purpose and presence amplify each other in Aries','the ego serves something heroic instead of something defensive'],detriment:['the self struggles for recognition in Aquarius — individuality dilutes into the collective','identity scatters when it should cohere — the spotlight feels foreign','the will operates through indirection, which costs energy'],fall:['vitality dims in Libra — the self over-accommodates and loses center','the need to please others erodes the capacity to please yourself','the will bends toward consensus and forgets what it actually wants']},
Moon:{domicile:['emotionally at home — instincts are reliable and the body is safe','Cancer Moon: the tides obey you, the shell fits perfectly','nurturing flows without effort and vulnerability feels protected'],exalted:['feelings are steady and strong in Taurus — the body anchors the heart','emotional resilience at its peak — what you feel, you can sustain','the inner world is fertile, stable, and deeply rooted'],detriment:['emotional armor hardens in Capricorn — feelings get managed instead of felt','the heart works overtime to maintain control and the cost is warmth','vulnerability registers as weakness, which means the real feelings go underground'],fall:['the emotions scatter in Scorpio — intensity without resolution','feelings are powerful but self-destructive patterns activate easily','the inner world is turbulent and the instincts run too hot to trust cleanly']},
Mercury:{domicile:['the mind operates at native speed in Gemini — quick, versatile, precise','Virgo Mercury: analysis is effortless, details organize themselves','communication hits exactly the register the moment requires'],exalted:['mental precision peaks in Virgo — the analytical mind is a scalpel','thought and expression align perfectly, every word earns its place','the intellect serves something practical and the results are flawless'],detriment:['the rational mind struggles in Sagittarius — big picture drowns the details','Pisces Mercury: logic dissolves into intuition and the message gets lost','thoughts scatter when they should focus, and focus feels reductive'],fall:['mental clarity dims in Pisces — the signal is beautiful but noisy','the mind receives more than it can process and confusion masquerades as depth','communication requires translation that loses something essential']},
Venus:{domicile:['desire and fulfillment are the same address in Taurus','Libra Venus: the heart knows exactly what it wants and how to get it gracefully','beauty, pleasure, and relationship operate at full natural capacity'],exalted:['love transcends the personal in Pisces — compassion and desire fuse','Venus exalted: attraction becomes devotion and beauty becomes sacred','the heart opens wider than self-interest and the generosity is genuine'],detriment:['love must fight for itself in Aries — tenderness costs effort','Scorpio Venus: desire is intense but trust is hard-won and easily shattered','the heart wants what gentleness cannot provide and the friction shows'],fall:['the heart goes analytical in Virgo — criticism replaces appreciation','affection gets filtered through standards nothing can meet','Venus in fall: the beautiful and the perfect become enemies of each other']},
Mars:{domicile:['pure drive in Aries — the will and the fuel are one thing','Scorpio Mars: strategic, relentless, operating with total commitment','action is effortless because the body and the intention agree completely'],exalted:['discipline converts raw force into enduring power in Capricorn','Mars exalted: every action builds something permanent','ambition and stamina fuse — you can sustain what others can only start'],detriment:['the drive softens in Libra — action requires negotiation first','Taurus Mars: stubbornness replaces strategy and momentum slows to a crawl','the impulse to act gets tangled in the impulse to accommodate'],fall:['the warrior energy scatters in Cancer — emotions interfere with action','Mars in fall: the fight turns inward and becomes self-sabotage','the energy is present but the direction keeps changing with every feeling']},
Jupiter:{domicile:['faith is rewarded in Sagittarius — the arrow flies true','Pisces Jupiter: compassion and abundance are limitless and sincere','expansion happens naturally because the environment welcomes growth'],exalted:['generosity and protection amplify each other in Cancer','Jupiter exalted: what you nurture grows beyond what you imagined','the abundance is emotional as well as material — everything multiplies'],detriment:['expansion is restricted in Gemini — too many paths, not enough depth','Virgo Jupiter: the optimism shrinks to fit the analysis and loses its power','faith gets cross-examined until nothing magnificent survives the scrutiny'],fall:['the vision narrows in Capricorn — pragmatism starves the faith','Jupiter in fall: ambition replaces generosity and the growth turns cold','what should expand contracts into strategy and misses the point']},
Saturn:{domicile:['the taskmaster is home in Capricorn — discipline becomes effortless','Aquarius Saturn: structure serves the collective and the rules make sense','authority is earned and wielded with quiet competence'],exalted:['responsibility becomes a source of power in Libra','Saturn exalted: fairness and structure reinforce each other perfectly','the hard work produces something balanced, beautiful, and lasting'],detriment:['authority falters in Cancer — the rules clash with the feelings','Leo Saturn: the weight of responsibility dims the natural light','discipline feels like punishment rather than structure'],fall:['the discipline cracks in Aries — impatience undoes what patience built','Saturn in fall: the structures are imposed rather than earned','control breaks down because the energy refuses to be contained']},
Uranus:{domicile:['the rebel is home in Aquarius — innovation flows without resistance','liberation and vision operate at full capacity, the future feels accessible','the unconventional is the natural — authenticity needs no defense'],exalted:['breakthrough clarity in Scorpio — revolution reaches the deepest layers','Uranus exalted: transformation is sudden, total, and irreversible','the lightning strikes where it is needed most'],detriment:['the revolutionary energy stalls in Leo — ego blocks the breakthrough','disruption becomes drama instead of liberation','innovation is loud but shallow when it serves the self instead of the vision'],fall:['instability without direction in Taurus — the ground shakes but nothing new emerges','the desire for change clashes with the need for security and both lose','Uranus in fall: rebellion costs more than it produces']},
Neptune:{domicile:['the mystic is home in Pisces — imagination and reality merge seamlessly','spiritual vision operates without distortion, intuition is trustworthy','the boundary between self and cosmos dissolves productively'],exalted:['compassion and creativity amplify each other in Cancer','Neptune exalted: the dream serves something nurturing and real','imagination produces beauty that heals rather than deceives'],detriment:['the vision clouds in Virgo — analysis destroys the magic','spirituality gets reduced to technique and the numinous drains away','Neptune in detriment: the dream is there but the mind keeps interrupting it'],fall:['illusion and ambition tangle in Capricorn — the dream becomes a scheme','Neptune in fall: what should be spiritual turns calculating','the imagination serves the ego instead of transcending it']},
Pluto:{domicile:['transformation is absolute in Scorpio — total metamorphosis, no half-measures','power operates at its deepest and most authentic level','the phoenix cycle completes itself with devastating efficiency'],exalted:['regenerative power peaks in Aquarius — collective transformation','Pluto exalted: destruction serves evolution on the largest scale','what dies makes room for something that benefits everyone'],detriment:['the transformative force is blunted in Taurus — change meets maximum resistance','power gets hoarded instead of channeled and stagnation sets in','Pluto in detriment: the necessary death is delayed past its useful timing'],fall:['power scatters in Leo — the transformation becomes theatrical instead of real','Pluto in fall: intensity serves drama rather than genuine change','what should be deep becomes a performance of depth']},
Chiron:{domicile:['the healer operates at full capacity — wound and wisdom are one','vulnerability becomes a teaching tool rather than a source of shame','the pain is transmuted into something that genuinely helps others'],exalted:['healing power amplifies — the wounded healer earns their title','old injuries become credentials and the suffering has a purpose','what broke you is now what qualifies you to help'],detriment:['the healing gift turns inward and becomes self-absorbed','the wound festers instead of teaching — pain without wisdom','the helper cannot reach the people who need them most'],fall:['the wound reopens without the wisdom to process it','healing stalls because the pain is too raw to transmute yet','Chiron in fall: the injury is vivid but the medicine is delayed']},
NorthNode:{domicile:['destiny flows freely — the path forward is unmistakable','evolutionary momentum carries you without resistance','what you are becoming and where you are going are perfectly aligned'],exalted:['the karmic trajectory amplifies — fate accelerates','encounters feel inevitable and growth is rapid and purposeful','the direction of your life sharpens to crystal clarity'],detriment:['the evolutionary pull weakens — old habits reassert themselves','the familiar path seduces you away from the necessary one','growth requires more effort because inertia has the advantage'],fall:['the soul direction is obscured — purpose feels uncertain','the compass spins and the next step is genuinely unclear','what you are supposed to become feels impossibly far from where you are']}
};
...
exalted:['magnified and honored','elevated beyond its usual range','riding high in its sign of exaltation','amplified and celebrated'],
...
const VERDICT_HARD_LEAD=[
  ...
  'stay with the difficulty — it is doing real structural work on your chart'
];
...
// ── Dignity context string (planet-specific with generic fallback) ──
function dignityContext(planet,lon){
  ...
  // Try planet-specific first
  const pp=DIGNITY_REFRAME_PLANET[planet];
  if(pp&&pp[key]){return ' — '+pick(pp[key],seed);}
  // Generic fallback
...
function planetInHouse(planet,house){
  const PH={
    Sun:{1:'People notice you when you walk into a room right now, whether you want them to or not. You feel an unusual pull to change your hair, your clothes, the way you introduce yourself. This is a time when how you look and how you feel about yourself become the same question.',2:'You catch yourself checking your bank balance more than usual, or mentally pricing things you want. Spending feels more intentional, like every purchase is a statement about who you are. Something about what you own — or don\'t — feels personal in a way it normally doesn\'t.',3:'Conversations feel like performances and you\'re the lead. You text more, talk more, write more — words pour out of you with unusual confidence. Siblings or neighbors may suddenly want your attention, and short trips feel oddly significant.',4:'You want to be home. Not hiding — more like nesting, organizing, or taking charge of the household. A parent or family matter demands your attention, and you realize how much of your identity is built on where you come from.',5:'Flirting comes easier. Creative projects feel urgent and personal, like they\'re an extension of your actual self. You want to be admired for something you made or something you dared to do — and honestly, you probably will be.',6:'Your morning routine suddenly matters. You reorganize your desk, start a new health kick, or overhaul your workflow with missionary zeal. The small stuff — meals, sleep, the quality of your daily grind — feels like it defines you right now.',7:'Someone else becomes your mirror. A partner, a close collaborator, even an open rival — they\'re showing you something about yourself you can\'t see alone. Relationships feel central to everything, and compromising without losing yourself is the real work.',8:'Bills, debts, joint accounts, insurance claims — the unglamorous machinery of shared money demands your focus. Deeper than that, you\'re thinking about control: who has it, who wants it, and what you\'re willing to expose to get it.',9:'You want to go somewhere you\'ve never been, or learn something that changes how you see everything. A book, a trip, a professor, a podcast — something cracks your worldview open a little wider. Ordinary life feels too small.',10:'Work dominates. Your boss notices you, for better or worse, and your professional reputation feels like it\'s on the line. You care about your legacy right now — not in a distant way, but as something you\'re actively building or defending today.',11:'You find yourself thinking about your people — your friend group, your online communities, the causes you care about. Social life feels like it matters more than usual. A friend might need you to step up, or you need them to.',12:'You don\'t want to perform for anyone. Sleep pulls you under, daydreams multiply, and time alone feels more nourishing than any social event. Something is composting beneath the surface, and the best thing you can do is let it.'},
    Moon:{1:'Your feelings are written on your face today — everyone can read you, and you can\'t fake your way through small talk. Physical comfort matters more than usual; the wrong shirt or a skipped meal can ruin your whole afternoon. You\'re reactive, sensitive, and more transparent than you\'d like to be.',2:'Retail therapy tempts. You want to buy something soft, comforting, or nostalgic, and your wallet is at the mercy of your mood. How much money you have in the bank directly affects your emotional equilibrium today.',3:'You call your sibling, text an old friend, or fall down an internet rabbit hole before noon. Words tumble out of you without much filtering — conversations feel emotionally loaded even when the topic is mundane. Short errands somehow turn into meaningful encounters.',4:'Home is the only place that feels right. You might rearrange furniture, cook an elaborate meal, or just sit on the couch thinking about your mother. Family memories surface without warning, and the house itself feels like an emotional barometer.',5:'You need to make something — draw, sing, cook, arrange flowers, anything. Romance is mood-driven: a sweet text could make your whole day, and a cancelled date could genuinely wreck it. Children, if you have them, are especially demanding of your emotional attention.',6:'A stomachache, a headache, a weird fatigue — your body is broadcasting your emotional state. Cleaning or organizing feels soothing in a way that logic can\'t explain. You might fuss over a pet or coworker the way a parent fusses over a child.',7:'You need someone to lean on, and you\'re painfully aware of whether that person is there. Partnerships feel like emotional weather systems — one kind word shifts everything. If you\'re single, the absence of a partner registers more sharply than usual.',8:'Something you don\'t normally think about — an old grief, a financial entanglement, a sexual memory — floats to the surface and sits there. Privacy feels essential. You might cry in the shower or have an unexpectedly intense conversation about money with your partner.',9:'You get emotional about ideas. A documentary makes you tear up. A conversation about meaning or purpose hits you somewhere deep. The urge to escape — to book a flight, drive somewhere unfamiliar — is coming from a feeling, not a thought.',10:'Your professional life is unusually emotional today. A boss\'s offhand comment stings for hours, or public recognition brings unexpected tears. You care about how the world sees you, and that caring feels raw and exposed.',11:'Friends are your emotional anchors today. A group chat, a cause you care about, a community gathering — these are where your heart is. Being excluded from something social would hurt more than usual right now.',12:'You need to be alone but can\'t always explain why. Dreams were vivid last night, and a vague melancholy hangs around the edges of the day. You\'re processing something you can\'t name yet, and solitude is the only medicine.'},
    Mercury:{1:'You\'re sharp, talkative, and quick on your feet. People remark on how articulate you are, or you catch yourself crafting the perfect comeback in real time instead of two hours later. Your mind and your mouth are unusually well-connected.',2:'Budgets, spreadsheets, price comparisons — your brain wants to do math. You read the fine print on things you normally skip. Conversations drift toward money, value, and what things are really worth.',3:'Your phone doesn\'t stop buzzing. Emails pile up, errands multiply, and you hop between five conversations without dropping a thread. Learning comes fast — you absorb new information like a sponge and immediately want to share it with someone.',4:'You think about the past. Old journals, family stories, the layout of a childhood bedroom — your mind keeps circling home. Working from home feels more productive than usual, and conversations with family members get surprisingly deep.',5:'Clever wordplay, witty flirting, intellectual games — your mind wants to play. Creative writing or brainstorming flows easily. You might find yourself drawn to puzzles, trivia, or the kind of conversation that feels like sparring.',6:'You make lists. You optimize systems. You Google your symptoms and then reorganize your supplement cabinet. Work problems yield to analysis, and you can spot inefficiency from across the room. The risk is overthinking your body.',7:'Negotiations, contracts, important conversations with your partner — this is when they happen. You think in terms of "we" more than "I" and can see the other person\'s perspective almost too clearly. Deal-making comes naturally.',8:'Your mind goes to dark, fascinating places. You research taboo topics, investigate financial fine print, or have a conversation so honest it leaves you shaken. You\'re thinking about what people aren\'t saying, and you\'re usually right.',9:'You sign up for a class, buy three books, or spend four hours reading about a country you\'ve never visited. Big ideas excite you — philosophy, religion, politics, anything that zooms out from the day-to-day. Travel plans might take shape.',10:'Work communication is front and center. You draft the important email, give the presentation, or finally have that conversation with your boss. Your professional voice is polished, and people in authority are listening.',11:'Group chats blow up. You\'re the one organizing the event, starting the thread, or proposing the plan. Your mind is social and future-oriented — you think about what your community could become, not just what it is.',12:'Thoughts loop quietly. You journal, meditate, or lie awake noticing the contents of your own mind. Therapy sessions are unusually productive. Insights arrive sideways, through dreams or idle moments, not through effort.'},
    Venus:{1:'You look good and you know it. People compliment you unprompted, your outfit choices feel inspired, and your whole vibe is softer and more magnetic than usual. Even strangers are friendlier.',2:'You buy yourself something beautiful — or at least you window-shop with serious intent. Money comes a little easier, and you feel drawn to quality over quantity. Your relationship to comfort and luxury is warm and uncomplicated right now.',3:'Sweet texts, charming small talk, a lovely note from a neighbor. Conversations have a pleasant, easy quality — even difficult topics get smoothed over. You might reconnect with a sibling or find a favorite new podcast.',4:'Home feels like a sanctuary. You buy flowers for the kitchen table, light candles, or invite someone over for a home-cooked dinner. Family relationships are warm, and nostalgia has a sweet rather than painful quality.',5:'Romance is the headline. Dates go well, creative work feels beautiful, and pleasure is everywhere — good food, good art, good company. If you have a crush, it\'s consuming. If you\'re in love, it deepens.',6:'The office is pleasant. A coworker brings you coffee, a tedious task becomes oddly satisfying, and your daily routine has a gentle rhythm to it. Health habits feel less like discipline and more like self-care. Your pet is extra affectionate.',7:'Relationships hum. Your partner does something thoughtful, a business collaboration clicks, or you meet someone who just gets you. Compromise comes easily. If you\'re single, you\'re more open to connection than usual.',8:'Intimacy is magnetic. Financial entanglements — shared accounts, debts, gifts — have a generous quality. Someone might offer you something valuable without you asking. The boundary between yours and theirs blurs in a way that feels good, for now.',9:'A foreign film makes you fall in love with a culture. Travel has a romantic quality — even imaginary travel, the kind you do through books and food and music. Your taste gets more cosmopolitan and your worldview more generous.',10:'Professional charm is at its peak. Your boss likes you, clients warm to you, and public appearances go smoothly. Career favors arrive through likability rather than brute force. You might get a raise or a compliment from someone who matters.',11:'Friends spoil you. Social events are genuinely fun rather than obligatory, and you meet people through groups who could become important to you. Community feels like a pleasure, not a chore.',12:'A private tenderness takes hold. You enjoy your own company more than anyone else\'s, and solitary pleasures — a bath, a favorite album, a walk alone — feel almost sacred. A secret crush or hidden affection may be at play.'},
    Mars:{1:'You\'re impatient, direct, and a little confrontational even before your first coffee. Physical restlessness demands an outlet — a run, a fight, or at minimum a very fast walk. People get out of your way, and you like it.',2:'Money becomes a battleground. You argue about bills, chase down overdue payments, or make an impulsive purchase that feels like a power move. What you own and what you earn feel like territory you need to defend.',3:'Your texts are blunt. You interrupt people. Arguments with siblings, neighbors, or strangers in traffic come easily and feel satisfying in the moment. Your mind is fast but your filter is off — you say it before you think it.',4:'Home renovation, aggressive cleaning, slamming doors. Family arguments flare up over things that have been simmering for weeks. You might rearrange an entire room at midnight because the energy has to go somewhere.',5:'You attack your creative project with raw determination. Dating feels competitive — you want to win someone over, not just meet them. Workouts become more intense, and you\'re drawn to physical games, risks, and showing off.',6:'You attack your to-do list with unusual ferocity. Workouts become more intense or you pick them up for the first time in months. Coworkers who slack off become personally irritating, and you might snap at someone over a trivial process failure.',7:'Arguments with your partner or business associate have real heat. You attract confrontational people, or you are the confrontational one and barely notice. Negotiations are aggressive — you push harder than the situation might require.',8:'Power struggles over money, sex, or control come to a head. You want to know someone\'s real motives, and you\'re willing to provoke them to find out. Debt, insurance, or someone else\'s finances make you angry.',9:'You argue about politics, religion, or philosophy with conviction that borders on aggression. Travel is impulsive — you book the trip and pack in twenty minutes. Physical adventure calls: hiking, climbing, anything that pushes your limits.',10:'Career ambition gets sharp teeth. You push for the promotion, confront a professional rival, or work sixteen-hour days because nothing less feels acceptable. Authority figures either respect your drive or find it threatening.',11:'You start arguments in group chats. A friend does something that sets you off, or you become the fierce advocate for a cause that nobody else will champion. Social dynamics feel competitive, and you\'re not here to lose.',12:'Anger goes underground. You\'re furious about something but can\'t quite articulate what or at whom. Intense workouts done alone, angry journaling, or passive-aggressive behavior leaks out. The real fight is internal.'},
    Jupiter:{1:'Confidence swells. You feel bigger than your usual self — more optimistic, more willing to take up space, more certain that things will work out. Weight gain is possible because everything feels abundant, including your appetite.',2:'Money arrives from unexpected directions, or you spend freely because scarcity feels like a distant memory. Investments, raises, or financial windfalls are genuinely possible. The danger is overextending because the feast feels permanent.',3:'Every conversation leads somewhere interesting. You sign up for two courses, subscribe to three newsletters, and tell everyone about the fascinating thing you just learned. Siblings and neighbors bring good news. Short trips are lucky.',4:'Your living situation upgrades. Maybe you move to a bigger place, or the house you\'re in starts to feel like an actual home. Family relations improve, a parent is generous, or you discover something about your roots that makes you proud.',5:'Joy is easy to find and hard to contain. Creative projects succeed beyond your expectations, romantic connections feel fated, and having fun doesn\'t carry guilt. You might take a gamble — creative, romantic, or literal — and win.',6:'That health issue finally gets a diagnosis, or a new routine clicks into place and stays. Work offers multiply, or your current job becomes genuinely satisfying. A coworker or employee does something that makes your life dramatically easier.',7:'A partnership — romantic or professional — brings real opportunity into your life. Legal matters tend to resolve in your favor. You meet someone generous, or an existing relationship enters a growth phase that surprises you both.',8:'Someone else\'s resources benefit you: an inheritance, an investment return, a partner\'s raise, a tax refund. Therapy or deep psychological work yields a breakthrough that\'s been years in the making. Intimacy is generous and transformative.',9:'The trip of a lifetime becomes possible. A professor, mentor, or book fundamentally shifts your understanding. Everything feels connected to a bigger picture, and for once that feeling is accurate rather than wishful.',10:'The promotion comes. The recognition arrives. Your professional reputation grows in visible, tangible ways. Authority figures are on your side, and the career path you\'ve been building suddenly has a clear summit in view.',11:'Your social circle expands in ways that change your life. A new friend introduces you to opportunities. Group involvement pays off, and the future you\'ve been dreaming about starts to feel possible rather than theoretical.',12:'Solitude is deeply restorative instead of lonely. Spiritual or contemplative practices yield real insight. Hidden help arrives — someone working on your behalf behind the scenes, or a fortunate coincidence you never see coming.'},
    Saturn:{1:'You feel older, heavier, more serious. The mirror is not kind, or maybe it\'s just honest. New responsibilities land on your shoulders, and people expect you to carry them. You earn respect by enduring, not by charming.',2:'Money is tight, or feels tight even if the numbers say otherwise. Spending becomes deliberate, and you cut luxuries without sentimentality. Something forces you to ask what you actually need versus what you just want.',3:'Words don\'t come easily. You second-guess every email, stumble through conversations that used to flow, and feel like nobody is hearing you correctly. Learning something new is slow and frustrating but ultimately permanent.',4:'A parent needs care, or the foundation of your home life cracks in a way that demands repair. You might move out of necessity rather than desire. Family obligations feel heavy, and the emotional basement of your life needs structural work.',5:'Fun requires effort. The creative project stalls, the date falls flat, and spontaneity feels like a foreign concept. What you make during this time is unglamorous but built to last, if you can push through the joylessness.',6:'Your body sends you a bill for old habits. A chronic issue demands attention, or your daily routine collapses and has to be rebuilt from scratch. Coworkers lean on you. The work is tedious, essential, and no one else will do it.',7:'A relationship reaches a pass-or-fail exam. Long-term partnerships either formalize or dissolve — engagement, divorce, or the honest conversation you\'ve been avoiding for three years. Casual connections feel pointless.',8:'Debt collects. An insurance claim gets complicated. Someone who owes you something — money, honesty, acknowledgment — refuses to pay. You confront uncomfortable truths about dependency and control.',9:'A belief you\'ve held for years stops working. Education is grueling but rewarding. Travel involves obligations rather than pleasure — a conference, a family duty, a pilgrimage that tests your patience.',10:'Career pressure is relentless. You either get the authority you\'ve earned or you watch it given to someone else. Your boss demands more, the stakes are real, and shortcuts do not exist. What you build now defines you for a decade.',11:'Friends drift away, or you realize some friendships were built on convenience rather than substance. Group obligations feel burdensome. The few connections that survive this period are the ones actually worth keeping.',12:'Old grief resurfaces. You spend more time alone, not by choice but by circumstance. Hidden debts — psychological, karmic, emotional — come due. The isolation is difficult, but it\'s clearing ground for something you can\'t see yet.'},
    Uranus:{1:'You dye your hair, quit something without warning, or say something in public that shocks even you. The person you\'ve been pretending to be is no longer tolerable. People around you can\'t predict what you\'ll do next, and neither can you.',2:'Your income source changes abruptly — a sudden layoff, an unexpected windfall, or a decision to walk away from financial security because it came at too high a price. Your relationship to money and ownership is being completely rewired.',3:'Your mind won\'t stay in one lane. You jump between topics, pick up strange new interests, and say things in conversation that surprise you as they leave your mouth. Technology might malfunction or suddenly become central to your daily communication.',4:'You move unexpectedly, or your home life gets disrupted by something nobody planned. A family member does something shocking. The place you\'ve always called home might not feel like home anymore, and that\'s terrifying and liberating in equal measure.',5:'Your creative output gets weird — experimental, boundary-pushing, maybe brilliant and maybe just strange. Romance follows no script: you\'re attracted to people who break your usual type, or an existing relationship needs radical freedom injected into it.',6:'Your daily routine explodes. The job changes overnight, or you abandon your old health regimen for something unconventional. Standard medical advice frustrates you. You want to hack your body and your workflow, and conventional approaches feel suffocating.',7:'Relationships demand more freedom than the current structure allows. A partnership might end suddenly, or a wildly unconventional person enters your life and rewrites your understanding of what a relationship can look like.',8:'A financial shock — an unexpected bill, a sudden inheritance, a partner\'s financial crisis — forces you to rethink shared resources. Psychologically, something you\'ve been repressing breaks the surface with startling force.',9:'Everything you believed gets challenged. A conversation, a trip, or a single book demolishes assumptions you didn\'t even know you had. You become fascinated by something your old self would have dismissed as fringe.',10:'Your career takes a sharp, unplanned turn. You might get fired, quit dramatically, or pivot into a field that makes no sense to anyone but you. The need for professional autonomy overrides any desire for stability.',11:'You\'re the one shaking up the friend group. New, unusual people enter your life while old connections that can\'t handle the new you fall away. A collective cause or technological community becomes unexpectedly central.',12:'Insight arrives like lightning at 3 AM. Dreams are bizarre and informative. Something you\'ve kept buried — a memory, a desire, a truth about yourself — surfaces without warning and refuses to go back underground.'},
    Neptune:{1:'People see what they want to see when they look at you, and you\'re not sure who\'s right. Your identity feels like water — hard to hold, easy to shape. Sensitivity to your environment is almost psychic. You absorb moods like a sponge.',2:'Money slips through your fingers in ways you can\'t quite track. Generous impulses compete with vague financial anxiety, and the spreadsheet never quite adds up. You might donate impulsively or fall for a purchase that promises transformation.',3:'Miscommunication is the theme. Texts get misread, conversations go sideways, and you can\'t tell if you\'re being poetic or just unclear. But your intuition is sharp — you know things before you\'re told them, even if you can\'t explain how.',4:'The house feels haunted — not literally, but ancestrally. Memories of childhood swim up unbidden, and the line between what really happened and what you felt happened gets blurry. Home might need repairs that seem to multiply the more you look.',5:'Creativity flows from somewhere you can\'t control. Music sounds different, colors look different, and romance carries an otherworldly quality that makes ordinary dating feel unbearable. The muse is present but she\'s unreliable.',6:'Fatigue you can\'t explain, sensitivities to foods that never bothered you, or a general fogginess that makes your to-do list feel impossible. Conventional fixes don\'t work. What helps is rest, water, gentleness, and reducing everything artificial.',7:'You idealize your partner or project qualities onto them that they don\'t actually possess. New relationships feel like destiny, which is intoxicating and dangerous. Seeing people as they truly are — neither saint nor villain — is the ongoing challenge.',8:'Psychological boundaries thin out. You feel other people\'s emotions as if they were your own, and shared finances have a confusing, murky quality. Something hidden is dissolving, and you can\'t rush the process or force clarity.',9:'Faith replaces logic, which is beautiful until you need directions. A spiritual tradition, a foreign culture, or a mind-expanding experience opens doors you didn\'t know existed. The risk is mistaking every door for the right one.',10:'People in your profession either put you on a pedestal or completely misunderstand what you do. Your public image is impressionistic rather than precise. Career in the arts, healing, or caregiving flourishes; career in anything requiring hard edges struggles.',11:'The group you belong to is idealistic, inspiring, and slightly disorganized. You attract fellow seekers, and together you imagine beautiful futures that may or may not materialize. Discerning genuine community from wishful thinking takes time.',12:'This is the quietest, deepest transit. The veil between waking and sleeping thins. You dream with unusual vividness, lose yourself in music or art, and feel a connection to something vast and unnamed. Loneliness and spiritual fullness coexist.'},
    Pluto:{1:'People sense something different about you and they can\'t name it. You walk into rooms and the temperature changes. Old versions of yourself are dying off — the way you dress, the way you speak, the persona you\'ve maintained for years is being dismantled from the inside.',2:'Your relationship with money becomes obsessive. You either hoard or purge, invest aggressively or refuse to spend at all. Something about financial security hits a survival nerve, and the intensity of your feelings about money surprises even you.',3:'Conversations go deep fast. Small talk is intolerable and you can spot a lie from across the room. You research obsessively, ask questions that make people uncomfortable, and your words carry a weight that can\'t be taken back.',4:'Family secrets surface. The dynamics in your household intensify — someone is controlling, someone is hiding something, or you realize that the foundation you built your life on has a crack that goes all the way down. Renovation, literal or emotional, is unavoidable.',5:'Creative work comes from a raw, almost dangerous place. Romance is all-consuming — you don\'t date casually during this transit, you fall into someone and lose yourself for a while. The things you create carry a charge that other people can feel.',6:'Work becomes an obsession or a battleground. You overhaul your health routine with frightening thoroughness, or a health crisis forces you to rebuild your relationship with your body from the ground up. Half-measures are not an option.',7:'Relationships strip you to the bone. A partner reveals a side of themselves you never suspected, or you become aware of power dynamics that have been operating beneath the surface for years. Casual partnerships are impossible; everything is a crucible.',8:'This is the most intense transit placement Pluto can have. Debts — financial, emotional, karmic — demand settlement. You confront death, loss, or the absolute limit of your control and discover what remains when everything else is gone.',9:'A belief you\'ve held since childhood gets destroyed, and what replaces it is harder and truer. You travel somewhere that changes you permanently, or you study something so deeply that you emerge as a different person.',10:'Career becomes a vehicle for power, and the question of whether you wield it wisely is not abstract. You might transform an institution, or an institution might try to crush you. Public life has stakes that feel existential.',11:'You transform every group you enter, and not everyone thanks you for it. Friendships are intense, sometimes uncomfortably so. A collective cause grips you with a ferocity that makes lukewarm involvement impossible.',12:'Something buried in your psyche is demanding to be excavated. Therapy, dreams, or solitary confrontation with your own shadow become the central project. The process is not gentle, but what it uncovers has been running your life without your knowledge.'},
    Chiron:{1:'An old insecurity about your appearance or identity flares up — maybe someone says something careless, or you catch your reflection and feel the gap between who you are and who you wish you were. Strangely, this is also when other people find your vulnerability most compelling.',2:'Money troubles, or the memory of old money troubles, activate a deep sense of not-enough. You might undercharge for your work or feel guilty about wanting more. Helping someone else with their financial confidence quietly heals your own.',3:'You stumble over your words at the worst moment, or a conversation reopens an old wound about not being heard. But when you speak from that bruised place — honestly, without performing — people listen in a way they never do when you\'re polished.',4:'Family visits stir up something ancient. A parent\'s old failure, a childhood home you lost, a sense of never quite belonging where you grew up — it\'s all active. You heal by building safety for others that you never had yourself.',5:'The creative block isn\'t technical — it\'s personal. Something about being seen, about putting your actual self into your work, triggers a fear that predates this project by decades. The art that comes from pushing through that fear is the most honest you\'ll make.',6:'Your body is telling you something your mind has been ignoring. A health flare-up or a breakdown in your daily routine points directly at an old pattern of self-neglect or overwork. You understand physical suffering in a way that makes you genuinely useful to others going through it.',7:'A relationship hits a nerve that\'s been tender since long before this partner arrived. You recognize an old pattern — choosing people who confirm your wound, or pushing away the ones who could heal it. Naming the pattern is half the cure.',8:'Trust becomes the central issue. Someone asks for more vulnerability than feels safe, or a financial entanglement exposes how hard it is for you to depend on anyone. The wound is ancient but the opportunity to tend it is right here.',9:'A crisis of meaning. The philosophy or faith that used to hold you together develops a crack, and you\'re left standing in the gap between what you were told and what you\'ve actually lived. The new belief you build from here will be genuinely yours.',10:'Professional recognition triggers impostor syndrome, or the lack of recognition confirms your deepest fear that you\'re not good enough. Either way, the wound is about external validation. Healing means deciding what success looks like on your own terms.',11:'A social situation makes you feel like the outsider again — the one who doesn\'t quite fit, who showed up but wasn\'t really invited. That old ache is the source of your greatest gift: you notice who else is standing at the edge of the room, and you bring them in.',12:'Something hurts and you can\'t point to it. A sadness without a clear source, a fatigue that sleep doesn\'t fix, a sense of carrying something invisible. The healing happens in silence, in solitude, in finally letting yourself feel what you\'ve been outrunning.'},
    NorthNode:{1:'Life keeps putting you in situations where you have to stand alone and make a visible choice about who you are. Hiding behind a relationship or a group identity is the comfortable default; stepping forward as a distinct individual is the growth.',2:'You\'re being asked to build something of your own — earn your own money, define your own values, rely on your own resources. Depending on a partner\'s income or an inheritance feels safe but keeps you from discovering what you can generate yourself.',3:'Every opportunity to ask a question, write something down, or engage with your immediate neighborhood is an opportunity to grow. The temptation is to stay in the big picture and philosophize; the work is in the specific, the local, the conversational.',4:'Home is where your growth is. Not career, not public life — the private foundation. Building a household, tending to family, investing in emotional security feels counterintuitive when the world rewards achievement, but it\'s where you\'re being pointed.',5:'Taking creative risks, falling in love, being playful without an agenda — these are your growing edges. Group approval is the comfortable fallback. Making something that\'s purely yours, or loving someone without committee consensus, is the real work.',6:'The spiritual retreat is seductive but the growth is in showing up for the mundane. Make the appointment. Fix the spreadsheet. Feed the animal. Serve someone without making it mystical. Practical competence is your soul\'s assignment right now.',7:'Independence is your comfort zone; real partnership is your frontier. Letting someone else\'s needs matter as much as your own, compromising without disappearing — this is harder than going it alone and more transformative than you expect.',8:'You\'re being asked to let go of something you can control in exchange for something you can\'t. Shared finances, deep vulnerability with a partner, confronting your own psychology — the comfortable shore is self-sufficiency, but the growth is in the deep water.',9:'Routine is safe. The unknown is where your growth lives. Booking the trip, enrolling in the course, questioning the belief you inherited — every expansion of your worldview is a step toward who you\'re becoming, even when it feels reckless.',10:'Staying home is comfortable. Stepping into public authority is the assignment. Your career, your reputation, the legacy you build in the world — these demand your attention even when the couch and the family kitchen feel so much safer.',11:'Personal glory is the old habit. Community is the new frontier. The friends you make, the groups you join, the future you build with others — these matter more than individual achievement, even though collaboration feels like dilution.',12:'Productivity is your security blanket. The growth is in letting go — of control, of busyness, of the need to be useful every waking minute. Solitude, rest, spiritual surrender, and the terrifying act of trusting what you cannot see are where your soul is headed.'}
  };
  const ph=PH[planet];
  return ph?ph[house]||'':'';
}
