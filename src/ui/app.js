...
function planetInHouse(planet,house){
  const PH={
    ...
    Uranus:{1:'You radiate unpredictability. Your self-image is in revolt, demanding authenticity over convention.',2:'Financial life is disrupted by sudden gains or losses. Your relationship to security is being rewired.',3:'Thinking patterns shatter and reform. Unexpected news, unconventional ideas, and restless curiosity dominate.',4:'Home life is unstable or unconventional. Freedom clashes with roots, and your living situation may change abruptly.',5:'Creative expression takes radical, experimental forms. Romance is electric but erratic.',6:'Daily routines resist structure. Health breakthroughs come through alternative or unconventional approaches.',7:'Partnerships attract unusual people or face sudden shifts. You need freedom within commitment.',8:'Sudden psychological awakenings around shared resources, inheritance, or intimacy. The taboo attracts you.',9:'Belief systems are overturned. You seek truth through rebellion against orthodoxy and through direct experience.',10:'Career path is nonlinear and innovation-driven. Authority structures chafe; you need autonomy in your public role.',11:'You are the revolutionary in your community. Friendships form around shared ideals and future visions.',12:'Flashes of insight emerge from the unconscious. Spiritual awakening comes suddenly and without permission.'},
    Neptune:{1:'Your identity shimmers and shifts. Others project onto you, and self-definition feels elusive but spiritually fertile.',2:'Financial boundaries dissolve. Idealism around money can lead to inspired generosity or confused losses.',3:'Communication becomes poetic, impressionistic, or prone to misunderstanding. Intuition speaks louder than logic.',4:'Home life carries a dreamlike quality. Family boundaries blur, and the ancestral past feels hauntingly present.',5:'Creativity flows from a transcendent source. Romance is idealized — beautiful and potentially illusory.',6:'Health is sensitive to environment and emotion. Service to others becomes a spiritual practice, but boundaries matter.',7:'You seek the divine in your partner. Relationships carry a soulmate quality, but discernment about who people actually are is essential.',8:'Psychic sensitivity around death, transformation, and shared resources. Boundaries between self and other dissolve at the deepest level.',9:'Spiritual seeking replaces dogma. Faith is mystical rather than institutional, and foreign experiences dissolve old worldviews.',10:'Public image is idealized or misunderstood. Career may involve healing, art, or compassionate service.',11:'Community ideals inspire you, but group dynamics can become confusing. You dream of a better world and attract fellow dreamers.',12:'Neptune is at home here. Spiritual life is rich, dreams are vivid, and the boundary between self and cosmos thins to nothing.'},
    Pluto:{1:'Your presence carries intensity others can feel. Identity undergoes periodic destruction and rebirth.',2:'Relationship to money and possessions is all-or-nothing. Financial power and survival instincts are deeply linked.',3:'Words carry weight and penetrating force. You see through surface communication to hidden motives.',4:'Family dynamics involve power, secrets, and deep psychological undercurrents. Healing the root system transforms everything above it.',5:'Creative expression channels raw, primal energy. Romance is consuming and transformative, never casual.',6:'Work becomes an arena for power dynamics and total dedication. Health crises can become catalysts for complete renewal.',7:'Partnerships are intense crucibles of transformation. You attract powerful others and must learn shared power without control.',8:'Transformation is your native element — you live where others only visit during crises. Power, shared resources, and psychological depth draw you in, and your regenerative capacity is immense.',9:'Beliefs are forged in fire. You pursue truth with obsessive depth and may experience worldview-shattering revelations.',10:'Career involves power, influence, and institutional transformation. Your public role demands you confront corruption or wield authority responsibly.',11:'You transform groups from the inside. Friendships are few but profoundly deep, and collective causes ignite your passion.',12:'The unconscious holds immense power. Hidden psychological material demands excavation. Solitude becomes the site of your deepest metamorphosis.'},
    Chiron:{1:'Your deepest wound is tied to identity itself — who you are feels fragile, yet this vulnerability becomes your gift to others.',2:'Self-worth carries an old wound. You may struggle to feel deserving of abundance, but teaching others their value heals your own.',3:'Early communication patterns left a mark. Words once failed you, and now you possess an unusual ability to say what others cannot.',4:'The wound lives in family and belonging. Home may have felt unstable, and you heal by creating the safety you never had.',5:'Creative self-expression and joy carry pain. Reclaiming the right to play, to be seen, and to take creative risks is the healing path.',6:'Health and daily functioning hold the wound. You understand suffering in the body and can become a gifted healer through that knowledge.',7:'Your deepest wound sits in partnerships. Early relationship patterns may repeat until you learn that healing comes through vulnerability with another, not in spite of it.',8:'Intimacy and shared power carry old pain. Trust was broken early, and the path to healing runs through the willingness to be truly known.',9:'The wound lives in meaning-making and belief. Faith was shaken, and you heal by building a philosophy from lived experience rather than borrowed certainty.',10:'Public life and achievement carry the wound. Recognition feels hollow or elusive, and healing comes through defining success on your own terms.',11:'Belonging to groups triggers the wound. You felt like an outsider, and your healing gift is creating communities where others like you can belong.',12:'The wound is hidden even from yourself. Unconscious suffering and spiritual isolation are real, but so is your capacity to heal through surrender and compassion.'},
    NorthNode:{1:'Your soul\'s growth direction points toward independent selfhood and courageous self-definition. The comfort zone is merging with others; the growth edge is standing alone.',2:'Your soul\'s growth direction points toward building your own resources, values, and self-sufficiency. The comfort zone is relying on others\' support; the growth edge is earning your own ground.',3:'Your soul\'s growth direction points toward communication, curiosity, and local engagement. The comfort zone is grand philosophizing; the growth edge is listening, learning, and speaking plainly.',4:'Your soul\'s growth direction points toward home, emotional roots, and inner security. The comfort zone is public achievement; the growth edge is building a private foundation.',5:'Your soul\'s growth direction points toward creative self-expression, joy, and personal risk. The comfort zone is group identity; the growth edge is daring to stand out and play.',6:'Your soul\'s growth direction points toward service, health, and practical skill-building. The comfort zone is spiritual retreat; the growth edge is showing up for the humble daily work.',7:'Your soul\'s growth direction points toward partnership, compromise, and genuine collaboration. The comfort zone is fierce independence; the growth edge is learning to share the path.',8:'Your soul\'s growth direction points toward deep intimacy, shared power, and psychological transformation. The comfort zone is material security; the growth edge is letting go and merging.',9:'Your soul\'s growth direction points toward expanding horizons through travel, higher learning, and faith. The comfort zone is familiar routines; the growth edge is the unknown territory.',10:'Your soul\'s growth direction points toward public life, authority, and visible achievement. The comfort zone is private and domestic; the growth edge is stepping onto the stage.',11:'Your soul\'s growth direction points toward community, collective vision, and friendship. The comfort zone is personal glory; the growth edge is serving something larger than yourself.',12:'Your soul\'s growth direction points toward spiritual surrender, solitude, and release. The comfort zone is busy productivity; the growth edge is dissolving the ego\'s grip and trusting the unseen.'}
  };
  const ph=PH[planet];
  return ph?ph[house]||'':'';
}
