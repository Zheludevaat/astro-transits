...
const URLS_TO_CACHE = [
  ...
  './src/voice/house-voice.js', './src/voice/natal-voice.js', './src/voice/aspect-voice.js?v=66',
  './src/voice/hard-brings.js', './src/voice/ingress-notes.js?v=66', './src/voice/tone.js?v=66',
  './src/voice/synastry-voice.js?v=66', './src/voice/astrocarto-voice.js', './src/voice/references.js',
  ...
  './src/data/chart-storage.js', './src/ui/app.js?v=66'
];
